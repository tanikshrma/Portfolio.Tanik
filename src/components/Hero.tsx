      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative">
        ...
        <div className="lg:col-span-7 z-10">
          ...
          >
            ...
            >
              <div className="w-10 h-10 rounded-full bg-red-600 flex items-center justify-center text-white transition-transform group-hover:scale-110 shadow-lg">
        ...
        <div className="lg:col-span-5 relative flex justify-end">
          ...
          <motion.div 
            ...
            className="absolute right-0 top-0 w-3/4 h-[120%] bg-red-600 origin-top"
          />
          ...
          <motion.div 
            ...
            className="absolute -left-14 md:-left-16 bottom-16 md:bottom-20 z-20 hidden md:block"
          >
